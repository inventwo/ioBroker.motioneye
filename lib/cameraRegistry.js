 ...
 * @property {boolean} [notificationImageExcluded] Opt-out — skip image in Telegram notification (default false)
 * @property {string} [notificationPostText] Text sent after the image
 * @property {boolean} [notificationTimestampExcluded] Opt-out — skip timestamp in post text (default false)
 * @property {boolean} [notificationExcluded] Opt-out checkbox (Notifications tab)
 * @property {string} [notificationRecipients] Comma-separated recipient names or chat IDs; empty = all enabled recipients
 * @property {boolean} [notificationSendImage] Legacy opt-in field — prefer notificationImageExcluded
 * @property {boolean} [notificationIncludeTimestamp] Legacy opt-in field — prefer notificationTimestampExcluded
 */
