 ...
 * @property {boolean} [notificationSendImage] Send cached snapshot image in Telegram notification
 * @property {string} [notificationPostText] Text sent after the image
 * @property {boolean} [notificationIncludeTimestamp] Append timestamp to post text
