...
**Telegram:** `snapshots.filePath` als `text` in `sendTo('telegram.0', 'send', { text: filePath, caption: '…' })` verwenden. **Nicht** die Download-URL aus Admin → Dateien (`:8081/files/...`) — die liefert HTML, kein JPEG.
