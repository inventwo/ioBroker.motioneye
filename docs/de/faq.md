...
5. Pro Kamera **Text vor dem Bild**, **Bild senden** / **Zeitstempel**, **Bei Bewegung** / **Bei Snapshot** (Dropdown Ja/Nein, Standard Ja), optional **Empfänger** (leer = alle aktiven; sonst Name oder Chat-ID).
