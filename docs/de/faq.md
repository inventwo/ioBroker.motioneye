...
5. Pro Kamera **Text vor dem Bild**, **Bild senden** / **Zeitstempel** / **Benachrichtigungen** (Dropdown Ja/Nein, Standard Ja), optional **Empfänger** (leer = alle aktiven; sonst Name oder Chat-ID).
